...
class DiscoveryDetailsResponseModel {
  ContextModel? context;
  Message? message;

  DiscoveryDetailsResponseModel({this.context, this.message});

  DiscoveryDetailsResponseModel.fromJson(Map<String, dynamic> json) {
...
class Providers {
  ...
  List<FulfillmentsResponseModel>? fulfillments;
  List<Items>? items;
  ...
  Providers.fromJson(Map<String, dynamic> json) {
    ...
    if (json['fulfillments'] != null) {
      fulfillments = <FulfillmentsResponseModel>[];
      json['fulfillments'].forEach((v) {
        fulfillments!.add(new FulfillmentsResponseModel.fromJson(v));
      });
    }
    if (json['items'] != null) {
      items = <Items>[];
