...
class FulfillmentDetailsResponseModel {
  FulfillmentDetailsContext? context;
  FulfillmentDetailsMessage? message;

  FulfillmentDetailsResponseModel({this.context, this.message});

  FulfillmentDetailsResponseModel.fromJson(Map<String, dynamic> json) {
